...
- extend the current runtime-facing provenance hooks past the last-move and last-message-source pages into broader interaction/object-state/script tracing
