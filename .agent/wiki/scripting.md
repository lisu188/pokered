...
- The current overlay now also records the last successful warp's source and target object provenance, but it is still intentionally observational only and does not yet trace broader script-state transitions or object toggles.
