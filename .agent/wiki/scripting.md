...
- The overlay is still intentionally observational only and does not yet trace broader script-state transitions, object toggles beyond the current `LAST_MAP` anchor, or multi-step cutscene progress.
