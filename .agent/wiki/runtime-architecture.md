...
- Runtime-facing provenance now includes last-warp, last-move, last-interaction, last-interaction-branch, last-state-gate, last-message, and last-message-source trace pages, but broader object-state/script-state trace hooks are still missing.
